                    ...
                    <div className="space-y-2">
                       ...
                       <div className="grid grid-cols-2 gap-2">
                         ...
                         {(order.status === 'delivered' || order.status === 'in-progress') && (
                           <Button size="sm" variant="success" className="text-[10px] h-8 bg-green-600 hover:bg-green-700 text-white" onClick={() => handleUpdateStatus(order._id, 'completed')}>Complete</Button>
                         )}
                       </div>
                    </div>
                  )}
